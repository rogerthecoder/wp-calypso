		...
		return (
			<PurchaseDetail
				...
				description={ i18n.translate(
					"We are setting up your new G Suite users but {{strong}}this process can take several minutes{{/strong}}. We will email you at %(email)s with login information once they are ready but if you still haven't received anything after a few hours, do not hesitate to {{link}}contact support{{/link}}.",
					{
						components: {
							strong: <strong />,
							link: (
		...
		<PurchaseDetail
			...
			description={
				<div>
					<p>
						{ i18n.translate(
							'We are setting up your new G Suite account but {{strong}}this process can take several minutes{{/strong}}. We will email you at %(email)s with login information once it is ready, so you can start using your new professional email addresses and other G Suite apps.',
							{
								components: {
									strong: <strong />,
								},
